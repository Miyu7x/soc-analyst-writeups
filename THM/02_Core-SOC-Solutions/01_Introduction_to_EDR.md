...
![T2 Crowdstrike process tree visibility](T2_crowdstike_visibility.png)
...
![T2 Crowdstrike detection dashboard](T2_crowdstrike_detection.png)
...
![T2 Crowdstrike response dashboard](T2-crowdstrike_response.png)
...
![T3 EDR and AV airport concept](T3_edr_av_airport.png)
...
![T3 How AV and EDR views processes](T3_edr_and_av.png)
...
![T4 EDR agents and the EDR console](T4_edr_agents_console.png)
...
![T6 EDR detection and response](T5_edr_detection_response.png)
...
4. On which URL was the exfiltration attempt being made on WIN-ENG-LAPTOP03?
   ...
   ![T7 Q4 Exfil URL](T7_q4_exfil_url.png)
