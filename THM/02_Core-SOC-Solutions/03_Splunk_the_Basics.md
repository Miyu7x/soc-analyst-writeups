...
![T2 First look at Splunk Dashboard](T2_first_splunk_dashboard.png)
...
![Indexer Search Head Forwarder](T3_indexer_searchhead_forwarder.png)

Splunk has 3 main components:

- **Forwarder** - A lightweight agent on endpoints that collects data and sends it to Splunk

![Forwarder Splunk example](T3_splunk_forwarder.png)
...
![Splunk Search Head](T3_splunk_search_head.png)
...
![Splunk Field Pairs](T3_splunk_fieldpairs.png)
...
![Splunk offers a variety of ways to view logs](T3_splunk_charts.png)
...
![T4 Splunk Add Data Tab](T3_add_data_tab.png)
...
![All the data types Splunk can ingest](T5_Splunk_data_types.png)
...
![Setting Source Type in Splunk](T5_set_source_type.png)
![T5 Splunk Input Settings](Splunk_input_settings.png)
![Review Splunk settings before submitting](T5_review_splunk_submit-1.png)
...
![First VPN Log uploaded to Splunk](T5_first_splunk_vpnlog.png)
...
![T5 Search for logs by Maleena](T2_logs_maleena.png)

   **Answer: 60**

3. What is the username associated with IP 107.14.182.38?

![T5 Q3 Username associated with IP](T5_q3_smithip.png)
...
![All events for following IP](T5_q5_allsource_ip.png)
