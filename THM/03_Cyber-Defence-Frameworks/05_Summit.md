...
![Sandbox malware](T1_sandbox_malware.png)
...
![Added malware MD5 hash to blocklist](Q1_add_hash_blocklist.png)

![First flag](T1_firstflag.png)
...
![Malware sample2.exe sandbox](T2_sandbox_example.png)

![Created a firewall rule to block malicious IP](T2_q2firewall_rule.png)
...
![Results for sandboxed sample3.exe](T3_q3_sandbox_example.png)

![DNS block rule](T3_dns_backdoor.png)
...
![Sample4.exe sandbox](T4_q4sandbox_example.png)

![Sigma rule - defense evasion via registry](T4_defense_evasion_sysmon.png)
...
![Sample5.exe sandbox](T5_q5sandbox_example.png)

![Sigma rule - C2 beacon network connections](T5_sigma_rule.png)
...
![Exfil commands log](T5_exfil_log.png)

![Sample6 sandbox](T6_sandbox_example.png)

![Sigma rule - exfiltration process creation](T6_sigma_exfill_rule.png)
