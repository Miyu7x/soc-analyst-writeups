...
## Task 2 — Alert Funnel
![T2 alert funnel](T2_alert_funnel.png)
...
![T4 escalate from L1 to L2](T4_escalating_l1_l2.png)
...
![T4 L2 E. Fleming](T4_l2_efleming.png)
A: THM{good_job_escalating_your_first_alert}

**Q3: After triaging the second new alert, what flag did you receive?**
![T4 Spike in alerts](T4_spike_alert_escalate.png)

![T4 revshell.exe Escalation to L2](T4_revshell_escalation.png)
...
### Communication by L2
![T5 Communication from L1 to L2](T5_communication_l2.png)
