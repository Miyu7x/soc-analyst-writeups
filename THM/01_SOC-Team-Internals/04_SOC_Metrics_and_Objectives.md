...
![T3 Triage metrics flow](T3_triage_metrics.png)
...
![T3 Data stealer scenario](T3_data_stealer_scenario.png)

![T3 Calculation for MTTD MTTA and MTTR](T3_mttd_calculation.png)
...
![T5 Time to respond is too high](T5_time_to_respond.png)

**A:** THM{mttr:quick_start_but_slow_response}

**Q2:** Flag from Scenario 2

![T5 SOC demo metrics](T5_soc_demo_metrics.png)

**A:** THM{mttd:time_between_attack_and_alert}

**Q3:** Flag from Scenario 3

![Readjust False Positive Rules](T5_falsepositive_rules.png)
