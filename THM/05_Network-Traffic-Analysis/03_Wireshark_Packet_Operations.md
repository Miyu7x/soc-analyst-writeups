...
![Resolved addresses example](wireshark_resolvedaddresses.png)
![Protocol hierarchy example](wireshark_protocolhierarchy.png)
![Conversations example](wireshark_conversation.png)
![Endpoints example](wireshark_endpoints.png)
![Name resolution menu](wireshark_nameresolutionmenu.png)
![Endpoint menu with name resolution](wireshark_endpointmenu.png)
![GeoIP location](wireshark_geoiplocation.png)
...
- What is the number of IPv4 conversations?
  ...
  ![](wireshark_ipv4conversations.png)
  - **Answer: 435**
...
- How many bytes (k) were transferred from the "Micro-St" MAC address?
  ...
  *Found Micro-ST under non-resolved addresses, then checked Endpoints for the byte count.*
  ...
  ![](wireshark_findmicrost.png)
  ![](wireshark_endpointbytes.png)
  - **Answer: 7474**

- What is the number of IP addresses linked with "Kansas City"?

  ![](wireshark_kansascity.png)
  - **Answer: 4**
...
- Which IP address is linked with "Blicnet" AS Organisation?
  ...
  *No search bar in this Wireshark version. Googled Blicnet to confirm it is a Bosnian ISP, then located it in Endpoints using the Country column.*
  ...
  ![](wireshark_bosnia.png)
  ![](wireshark_blicnet.png)
  - **Answer: 188.246.82.7**
...
- What is the number of HTTP Requests accomplished by "rad[.]msn[.]com"?
  ...
  *HTTP Statistics tree works but display filter is faster and more precise.*
  ...
  ![](wireshark_httpnumber.png)
  ![](wireshark_httpgetfilter.png)
  - **Answer: 39**
...
- What is the number of packets with "even TTL numbers"?
  ...
  *`ip.ttl` is numeric. `string()` converts it so `matches` can apply a regex. `[02468]$` anchors to the last digit -- any TTL ending in an even digit.*
  ...
  ![](wireshark_stringconversion.png)
  - **Answer: 77289**
