...
![THM spf workflow diagram](spf_workflow_diagram.png)
...
![THM examples of records syntax](spf_records_syntax.png)
...
![Thm example of their spf record](thm_spf_record.png)
...
![SoftFail example](spf_soft_fail.png)
...
![Thm mail diagram](thm_dkim_diagram.png)
...
![Thm's dmarc records](thm_dmarc_records.png)

![Micrsoft passes all DMARC checks](dmarc_microsoft.png)
### Task Questions
...
![Wireshark list of smtp filters](smtp_wireshark_filters.png)
### Task Questions
...
![Results for wireshark smtp response code ](smtp_220codes.png)
- **Answer: 19**
...
![Smtp contains "spamhaus"](smtp_contains.png)
- **Answer: 553**
...
![SMTP response 55 = 6 results](smtp_response552.png)
- **Answer: 6**
