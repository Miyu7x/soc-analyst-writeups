...
![Alert management platform](T2-alert-management-platform.png)
...
### Task Questions
![TryHackMe SIEM dashboard](T2-tryhackme-siem.png)

<!-- Q: -->
![T2 question 1 alerts](T2-q1-alerts.png)

Answer: 5

![T2 question 2 alert name](T2-q2-alert-name.png)
...
![T3 alert properties](T3-alert-properties.png)

![T3 alert description](T3-alert-description.png)
### Task Questions

**Unusual VPN Login Location**
![T3 alert question](T3-alert-question.png)

<!-- Q: -->
![T3 question 1 verdict](T3-q1-verdict.png)
Answer: False Positive

![T3 question 2 user](T3-q2-user.png)
Answer:  M.Clark
<!-- A: -->
...
<!-- Q: -->
![T4 question 1 priority](T4-q1-priority.png)
Answer: Yea

![T4 question 2 alert order](T4-q2-alert-order.png)
Answer: Nay

![T4 question 3 in progress](T4-q3-in-progress.png)

On the list of Alerts selected the Critical severity alert and assigned it to In Progress
![T4 question 3 data exfiltration](T4-q3-data-exfil.png)
...
![T5 alert triage path](T5-alert-triage-path.png)
### Triage Workflow
...
![T5 question 1 critical alert](T5-q1-critical.png)

![T5 question 1 edit alert](T5-q1-edit-alert.png)

![T5 question 1 priority alert](T5-q1-priority-alert.png)
...
![T5 question 2 high alert](T5-q2-high-alert.png)

Provided with MD5 hash I investigated it through www.virustotal.com
![T5 question 2 virustotal](T5-q2-virustotal.png)

![T5 question 2 escalate to L2](T5-q2-escalate-to-L2.png)

![T5 question 2 double extension](T5-q2-double-extension.png)
...
![T5 question 3 low severity](T5-q3-low-severity.png)

![T5 question 3 G Chandler](t5-q3-gchandler.png)
