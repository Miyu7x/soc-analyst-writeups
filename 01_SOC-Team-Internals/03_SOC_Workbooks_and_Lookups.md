...
![T3 Network diagram scenario](T3_network_diagram_scenario.png)

![T3 Attack reconstruction](T3_reconstruct_attack.png)

![T3 Network Diagram](T3_network_diagram_scenario-1.png)
...
![T4 SOC workbook example](T4_workbook_example.png)
