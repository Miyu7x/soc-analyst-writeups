...
![Splunk query sorted by count surfacing tunnelcorp.net](dnsexfilexample.png)
...
![Wireshark filter dns && dns.qry.name contains tunnelcorp showing 315 results](wiresharktunnelcorp.png)
...
![Splunk where len query > 30 filtered results showing 192.168.1.103 at top](tunnelcorplen.png)
...
![Wireshark filtered by ftp contains guest showing 5 connections](wiresharkftpguest.png)
...
![Wireshark filtered by root account showing customer_data.xlsx in STOR command](filterbyroot.png)
...
![Wireshark ftp && frame.len > 90 sorted by length showing 192.168.1.105 at top](largeguestpayload.png)
...
![TCP stream of FTP CSV transfer revealing the flag](thmftpexfil.png)
...
![Wireshark POST filter frame.len > 750 showing single result with src IP](packetbytesthmflag.png)
...
![HTTP stream showing flag in exfiltrated content](packetbytesthmflag2.png)
...
![ICMP packet bytes showing flag in payload data](icmplogflag.png)
