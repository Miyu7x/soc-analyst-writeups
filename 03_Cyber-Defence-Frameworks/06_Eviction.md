...
![APT28 group description](apt28_description.png)

![Russian hacker group Fancy Bear](apt28_russian_fancybear.png)
...
![Fancy Bear preferred recon method](apt28_recon.png)
...
![Email Accounts](apt28_email_accounts.png)
...
![User Execution sub-techniques](q3user_execution.png)
...
![APT28 Execution phase](q4_executionphase.png)
...
![Rundll32 highlighted in Navigator](rundll_apt28.png)

![Rundll32 technique description](rundll32_description.png)

- **Answer: Rundll32**

### Q7. Sunny identified tcpdump on one of the compromised hosts. Which technique might the APT be using here for discovery?

![Network Sniffing technique](apt28_networksniffing.png)
...
![APT28 lateral movement](apt28_lateralmovement.png)
