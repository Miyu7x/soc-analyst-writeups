...
![Example of DNS log](dns_queries_firewall.png)
...
![THM TCP/IP model](thm_tcp_ip_model.png)
...
![Firewall log entry](thmfirewall_logentry.png)
...
![Session hijacking example](thm_sessionhijack_example.png)
...
![Fragmentation / IDS evasion example](thm_ids_log.png)
...
![ARP spoofing example](arp_spoof_example.png)
...
![HTTPS flow example](thm_flow_example.png)
...
![DNS flow example](thm_dns_flowexample.png)
...
![SMB with Kerberos flow](thm_smb_kerberos_flow.png)
...
![Physical network TAP](physical_network_tap.png)

![Port mirroring / SPAN](thm_port_mirroring.png)
...
![Network statistics example](thm_network_statisticsexample.png)
...
![Network traffic scenario](networktraffic_scenario.png)

![Malicious PowerShell download](malicious_psdownload.png)

### Task Questions

![TAP placement -- web proxy](first_tap.png)

- **What is the flag found in the HTTP traffic in scenario 1?**

![Network TAP flag](networktap_flag.png)
...
![DNS TAP flag find](dns_tap_flagfind.png)

![DNS TXT flag](dnstxt_flag.png)
