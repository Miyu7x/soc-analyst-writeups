...
![Capture file comments](wireshark_capturecomments.png)
  - **Answer: TryHackMe_Wireshark_Demo**

- **What is the total number of packets?**

![Total number of packets](wireshark_numberofpackets.png)
  - **Answer: 58620**
...
![7-layer HTTP packet example](wireshark_7layerpacket.png)
...
![Extensible markup language](wireshark_extensiblelanguage.png)
  - **Answer: eXtensible Markup Language**

- **What is the arrival date of the packet? (Month/Day/Year)**

![Packet arrival date](wireshark_arrivalpacket.png)
  - **Answer: 05/13/2004**

- **What is the TTL value?**

![TTL value](wireshark_ttl.png)
  - **Answer: 47**

- **What is the TCP payload size?**

![TCP segment size](wireshark_tcpsegment.png)
  - **Answer: 424**
...
![Expert information panel](wireshark_expertinformation.png)
...
![r4w string search result](wireshark_r4wstring.png)
  - **Answer: r4w8173**
...
![Packet 12 comment -- go to 39765](wireshark_gotopacket39765.png)

![Export JPEG from packet bytes](wireshark_exportjpeg.png)

![MD5 hash result](wireshark_md5hash.png)
...
![Export txt object](wireshark_exporttxt.png)

![cat txt file contents](wireshark_cattxt.png)
  - **Answer: Packetmaster**

- **Look at the expert info section. What is the number of warnings?**

![Expert info warnings count](wireshark_expertwarnings.png)
  - **Answer: 1636**
...
![HTTP display filter applied](wireshark_httpfilter.png)
  - **Answer: http**
...
![Second artist name](wireshark_blad3.png)
  - **Answer: Blad3**
