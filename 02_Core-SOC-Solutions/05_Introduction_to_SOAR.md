...
![What SOAR does](T3_soar_table.png)

![Before and after SOAR](T3_before_after_soar.png)
...
![Phishing playbook](T4_phishing_playbook_example.png)
...
![CVE patching playbook](T4_cve_playbook_example.png)
...
![Building the first SOAR workflow](T5_building_first_soar.png)

![Setting up automation](T5_settingup_automation_soar.png)

![Case ticket management](T5_case_management_settings.png)

![Threat intel automation](T5_threatintell_automation.png)

![Incident data extraction](T5_incidentdata_extraction_automation.png)

![Reputation checks](T5_reputation_checks.png)

![Course of action](T5_correct_course_action.png)
