...
![SIEM data flow diagram](T3_siem_flow.png)
...
![Log ingestion methods in Splunk](T4_various_ways_logs.png)
...
4. Examine the rule and the suspicious process; which term matched the rule that caused the alert?
   ...
   ![Detection rule that matched](T6_chris_rule_alert.png)

   **Answer: Miner**

5. Which option best represents the event? (False Positive / True Positive)

   ![True Positive classification](T6_chris_tp.png)
