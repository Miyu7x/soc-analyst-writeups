...
In our earlier investigation, we know the attacker used Base64! To double check we can look up the host resolvecyber we also found earlier and we not the info parameter all include "q=" which indicates Base64 also.
